...
/*Η συγκεκριμένη custom βιβλιοθήκη συνοδεύεται από το elementsutils.c και γράφτηκε για να οργανώσει τις συναρτήσεις που ασχολούνται με την δημιουργία των element-structs και
